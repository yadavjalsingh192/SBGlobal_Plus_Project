...
## Build 2 additions (31-08-2026 – 04-09-2026)
...
| AC-19 | F-06 §6.1 | Approved Global Brand Palette adopted as ACTIVE at Foundation level: Primary Cyan `#06B6D4`, Primary Hover Blue `#2563EB`, Secondary Deep Teal `#0F766E`, Accent Purple `#7C3AED`; Success `#16A34A` / Warning `#F59E0B` / Danger `#DC2626` / Info `#0284C7`, backgrounds and text values unchanged. Single canonical owner = F-06 §6.1; design-token instantiation deferred to Architecture/Detailed Design | USER-DIRECTED migration (04-09-2026). Semantic-role rule: `#0F766E` retained as Secondary (NOT globally replaced); `#115E59` holds no ACTIVE role; historical palette preserved in RawSourceCorpus as immutable evidence. In-place corpus edit in commit a811a1ab flagged as source-integrity defect RR-03 — ACTIVE palette lives here, never in the corpus; corpus restoration pending (see REVIEW_REQUIRED) |
